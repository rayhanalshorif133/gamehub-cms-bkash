...
<div class="offcanvas offcanvas-bottom custom-offcanvas" style="--bs-offcanvas-bottom:-50%" tabindex="-1"
    ...
    <div class="game-info text-center mb-4 pt-4">
        <div class="game-image text-center mb-3 modal-header d-flex" style="background-color: azure;">
            <img src="<?php echo e(asset('assets/images/coin.png')); ?>" alt="coin symbol" class="shake" />
        </div>
        <style>
            .success-wrapper {
                border-radius: 12px;
        ...
        <div class="modal-content" style="height:auto;overflow-y:inherit;">
            ...
            <div class="modal-header bg-red">
                <div class="game-image">
                    <img src="<?php echo e(asset('assets/images/user.png')); ?>" alt="Game Image" class="img-fluid">
                </div>
            </div>
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-login" role="tabpanel"
                        ...
                        <form method="POST" action="<?php echo e(route('player.login')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
                                <label for="login_phone" class="form-label"><?php echo e(__('Phone Number')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                <label for="login_password" class="form-label"><?php echo e(__('Password')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="tab-pane fade" id="nav-register" role="tabpanel" aria-labelledby="nav-register-tab">
                        ...
                        <form method="POST" action="#" class="regFrom">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
                                <label for="reg_name" class="form-label"><?php echo e(__('Name')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                <label for="reg_phone" class="form-label"><?php echo e(__('Phone Number')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                <label for="reg_password" class="form-label"><?php echo e(__('Password')); ?></label>
...
<?php /**PATH D:\Rayhan\Development\gamehub-cms-bkash\resources\views/_partials/modal.blade.php ENDPATH**/ ?>