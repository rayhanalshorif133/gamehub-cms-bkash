<div class="modal fade" id="createCampainsModal" tabindex="-1" aria-labelledby="createCampainsModalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.campaign.create')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select class="form-select" name="levels[0][prize_id]" required>
                                        ...
                                        <?php $__currentLoopData = $prizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prize): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($prize->id); ?>"><?php echo e($prize->title); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="mb-3 col-md-6">
...
<?php /**PATH D:\Rayhan\Development\gamehub-cms-bkash\resources\views/campaign/create.blade.php ENDPATH**/ ?>