...
<body style="overflow-x: hidden; background-color: #f4f7f6;">
    ...
    <header class="container mt-3">
        <div class="navbar justify-content-center">
            <img src="<?php echo e(asset('/images/logo.png')); ?>" alt="logo" style="width:8.5rem;" />
        </div>
    </header>
        ...
        <div class="carousel-inner">
            ...
            <?php $__currentLoopData = $campaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $campaign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="carousel-item <?php echo e($key == 0 ? 'active' : ''); ?>">
                   <div class="game-box-container" style="background-image: linear-gradient(135deg, #fce4ec 0%, <?php echo e($campaign->game->bg_color); ?> 100%);">
                        <div class="game_card_text mb-3">
                            <h1 class="fw-bold h3">Play & Win</h1>
                            <h2 class="text-muted h5"><?php echo e($campaign->game_name ?? 'Stick Monkey'); ?></h2>
                        </div>

                        <div class="image-container position-relative">
                            <img src="<?php echo e(asset($campaign->banner)); ?>" class="img-fluid rounded-4" alt="Game Banner">
                        ...
                        <div class="d-flex justify-content-between text-danger fw-bold mb-3 small">
                            <span>Start: <?php echo e(\Carbon\Carbon::parse($campaign->start_date)->format('d M Y')); ?></span>
                            <span>End: <?php echo e(\Carbon\Carbon::parse($campaign->end_date)->format('d M Y')); ?></span>
                        </div>
                        ...
                        <div class="rules-wrapper mb-3">
                            <div class="section-title-toggle" onclick="toggleSection('rulesContent<?php echo e($key); ?>', 'rulesIcon<?php echo e($key); ?>')">
                                <span><i class="fas fa-scroll me-2 text-success"></i> Tournament Rules</span>
                                <i class="fas fa-chevron-down" id="rulesIcon<?php echo e($key); ?>"></i>
                            </div>
                            <div id="rulesContent<?php echo e($key); ?>" class="content-hidden">
                        ...
                        <div class="prizes-wrapper mb-3">
                            <div class="section-title-toggle" onclick="toggleSection('prizeContent<?php echo e($key); ?>', 'prizeIcon<?php echo e($key); ?>')">
                                <span><i class="fas fa-trophy me-2 text-warning"></i> Weekly Prizes</span>
                                <i class="fas fa-chevron-down" id="prizeIcon<?php echo e($key); ?>"></i>
                            </div>
                            <div id="prizeContent<?php echo e($key); ?>" class="content-hidden">
...
<?php /**PATH /var/www/bdg.b2mwap.com/resources/views/landing/index.blade.php ENDPATH**/ ?>