        ...
        <div class="modal fade" id="createPrizeModal" tabindex="-1" aria-labelledby="createPrizeModalLabel"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form action="<?php echo e(route('admin.prize.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        const handleDataTable = () => {
            $('#prizeTableId').DataTable({
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(route('admin.prize.index')); ?>", // Apnar route er naam
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Rayhan\Development\gamehub-cms-bkash\resources\views/prize/index.blade.php ENDPATH**/ ?>