...
<body style="overflow-x: hidden;">
    ...
    @if (Auth::check())
        <header class="container">
            <div class="navbar">
                <div class="logo">
                    <img src="{{ asset('/images/logo.png') }}" alt="logo" class="site_logo" style="width:106px;" />
                </div>
                <div class="d-flex">
                    <div class="container coin-container">
                        <a class="coin-container-box" href="{{ route('player.points') }}">
                            <img src="{{ asset('assets/images/coin.png') }}" alt="coin symbol" class="coin_image" />
