            ...
            <div class="game-card game_over_card" style="padding: 2rem" data-campid="{{ $camp_id }}">
                ...
                <div class="game_over_image-container">
                    ...
                    {{-- @if (!($currentTime >= $startTime && $currentTime <= $endTime))
                        <div class="score_active_container">
                            <p>
                                Score is LIVE from 10:00 AM to 11:59 PM 🚀
                            </p>
                        </div>
                    @endif --}}
                    <img src="{{ $game->icon }}" alt="Stick Monkey" class="game_icon">
                    <div class="game_icon_shadow"></div>
                    <div class="score_container">
                        <h2 class="game_over_game_title">{{ $game->title }}</h2>
                        <div class="score_container_update">
                            <h1>YOUR SCORE:</h1>
                            <h2>{{ $score }}</h2>
                            <h3>Times Played: <b>{{ $playTimes }}</b></h3>
                    ...
                    @if ($boost != null)
                        <div class="active_boost_container">
                            <span class="dot"></span>
                            <strong>Boost Active:</strong> {{ $boost->remaining_time }} left
                        </div>
                    @endif
                ...
                {{-- @endif --}}
                @if ($camp_id != 'free' && $leaderboardEnabled)
